...
class WhackAMoleGame:
    def __init__(self, root1, width=600, height=400, mole_size=55, time_limit=30):
        self.root = root1
        ...
        self.canvas = tk.Canvas(root1, width=self.width, height=self.height, bg="green")
        self.canvas.pack()

        self.mole_color = "brown"
        self.mole_id = None
